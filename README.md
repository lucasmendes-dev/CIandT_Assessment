Repositório destinado para salvar minhas soluções para o processo seletivo de estágio da CI&T.

São desafios de lógica de programação, onde escolhi a linguagem PHP para resolver. Segue abaixo o enunciado de cada um dos desafios:
